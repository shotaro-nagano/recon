  ...
  return (
    <span
      ...
      style={{
        ...
        background: n === 1 ? 'var(--accent-faint)' : undefined,
      }}
    >
      {n === 1 ? 'P1 · 最優先' : `P${n}`}
    </span>
...
export default function PracticeMenuTab() {
  ...
  return (
    <div className="stack">
      ...
      {/* 優先度付きメニュー */}
      {menu.map((sec) => (
        <section key={sec.category.key} className="card cat-card accent-fade" data-p={`P${sec.priority}`}>
            ...
            <div style={{ minWidth: 0, flex: 1 }}>
              <div className="spread" style={{ gap: 8, alignItems: 'flex-start' }}>
                <div style={{ minWidth: 0 }}>
                  ...
                  <h2 className="display" style={{ fontSize: 16, color: 'var(--court-line)' }}>{sec.category.label}</h2>
                </div>
